...
<html lang="es">
  <head>
    <meta charset="utf-8">
    <meta name="description" content="Mantención Alejandrina Bustos">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Alejandrina Bustos>
    <meta name="theme-color" content="#009688">
    <link rel="shortcut icon" href="<?= media();?>/images/1.ico">
  ...
  <body class="app sidebar-mini">
    ...
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?= base_url(); ?>/dashboard">Mantención</a>
